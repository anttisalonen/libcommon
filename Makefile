...
COMMONSRCS = TextRenderer.cpp DriverFramework.cpp SDLSurface.cpp Texture.cpp SDL_utils.cpp Color.cpp Math.cpp Clock.cpp Steering.cpp Random.cpp Matrix44.cpp Quaternion.cpp Line.cpp
